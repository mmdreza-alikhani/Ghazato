                            ...
                            <div class="col-lg-8">
                                <div class="page-header-title text-left-rtl">
                                    <div class="d-inline">
                                        ...
                                        <span class="lite-text">غذا ها</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">غذا ها</li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="jumbotron shade pt-5">
                <div class="row mx-1">
                    <div>
                        ...
                        <a href="{{ route('admin.foods.trash') }}" class="btn btn-outline-secondary" style="max-width: fit-content">
                    ...
                    <div>
                        <form action="{{ route('admin.foods.search') }}" method="GET">
                            <input type="text" class="form-control" placeholder="جستجو بین غذا ها با عنوان یا شناسه" style="width: 250px" value="{{ request()->has('keyword') ? request()->keyword : '' }}" name="keyword">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ route('admin.foods.store') }}" method="POST" class="row" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-12 col-lg-4">
                                        ...
                                        <input id="price" name="price" type="tel" value="{{ old('price') }}" class="form-control" required>
                                    </div>
                                    <div class="form-group col-12 col-lg-4">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-12 col-lg-4">
                                                            ...
                                                            <select id="shop_id" class="form-control" disabled>
                                                                @foreach($shops as $shop)
                                                                    <option value="{{ $shop->id }}" {{ $food->shop_id == $shop->id ? 'selected' : '' }}>{{ $shop->title }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="form-group col-12 col-lg-4">
                                                        ...
                                                        <div class="form-group col-12 col-lg-4">
                                                            <label for="price">قیمت(به ریال):*</label>
                                                            <input id="price" type="tel" value="{{ number_format($food->price) }}" class="form-control" disabled>
                                                        </div>
                                                        <div class="form-group col-12 col-lg-4">
                                                            <label for="status">وضعیت:*</label>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="form-group col-12 col-md-3">
                                                                            ...
                                                                            <input id="discounted_price" type="tel" value="{{ $food->discounted_price }}" class="form-control" disabled>
                                                                        </div>
                                                                        <div class="form-group col-12 col-md-3">
                                                        ...
                                                        <div class="form-group col-12 col-lg-6">
                                                            ...
                                                            <input id="created_at" type="text" value="{{ verta($food->created_at) }}" class="form-control" disabled>
                                                        </div>
                                                        <div class="form-group col-12 col-lg-6">
                                                            <label for="updated_at">زمان ایجاد آخرین تغییر:*</label>
                                                            <input id="updated_at" type="text" value="{{ verta($food->updated_at) }}" class="form-control" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="{{ route('admin.foods.update' , ['food' => $food->id]) }}" method="POST">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-12 col-lg-4">
                                                                <label for="price">قیمت(به ریال):*</label>
                                                                <input id="price" name="price" type="tel" value="{{ $food->price }}" class="form-control" required>
                                                            </div>
                                                            <div class="form-group col-12 col-lg-4">
                                                                <label for="status">وضعیت:*</label>
                                                                <select class="form-control" id="status" name="status">
                                                                ...
                                                                <div class="card">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="row">
                                                                            <div class="form-group col-12 col-md-3">
                                                                                <label for="discounted_price">قیمت حراجی</label>
                                                                                <input id="discounted_price" type="tel" name="discounted_price" value="{{ $food->discounted_price }}" class="form-control">
                                                                            </div>
                                                                            <div class="form-group col-12 col-md-3">
                                                                                <label for="discounted_quantity">تعداد حراجی</label>
