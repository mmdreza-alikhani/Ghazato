...
@section('content')
    ...
    <section class="our-menu section-primary pb-113">
        <div class="container" style="background: rgba(35, 41, 48, 0.8);border-radius: 5px;">
            <div class="section-header">
                <h2 class="text-white">محبوب ترینها</h2>
                <span style="font-family: Vazir-Medium">~ سفارش مستقیم از ما ~</span>
            </div>
                ...
                @foreach($categories as $category)
                    <div class="col-md-6">
                        <div class="our-menu-col {{ $loop->iteration / 2 != 0 ? 'left' : 'right'}}">
                            ...
                            <div class="body">
                                @foreach($category->mainFoods as $food)
                                <div class="menu-item">
                                    <h5>
                                        <a href="{{ route('home.foods.show', ['food' => $food->slug]) }}" style="font-family: Vazir-Medium">{{ $food->title }}</a>
